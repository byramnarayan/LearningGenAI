...
available_tools = {
    ...
    "run_command": run_command # for coding agent build 
}
...
while True:
    ...
    while True:
        ...
        if parsed_result.step == "START":
            ...
            continue
#  parsed_result.step , parsed_result.content, parsed_result.tool, parsed_result.input
#  parsed_result.content equals to  parsed_result.get("content", None) and so on for tool and input
